    ...
    <PageLoaderWrapper screenState>
                ...
                <div className="flex flex-col gap-2">
                  <div className="w-1/3">
                    <ConnectorAccountDetailsHelper.RenderConnectorInputFields
                      ...
                      description="This is an unique label you can generate and pass in order to identify this connector account on your Bliver dashboard and reports. Eg: if your profile label is 'default', connector label can be 'stripe_default'"
                    />
                  </div>
      ...
      <div className="bg-jp-gray-light_gray_bg flex py-4 px-10 gap-2">
        ...
        <p className=p2RedularTextClass>
          {"| Bliver is PayPal's trusted partner, your credentials are secure & never stored with us."->React.string}
        </p>
      </div>
    </PageLoaderWrapper>
  </div>
