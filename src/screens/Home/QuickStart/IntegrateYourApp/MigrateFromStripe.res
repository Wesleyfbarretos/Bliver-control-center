...
let make = (
  ...
  <QuickStartUIUtils.BaseComponent
    ...
    | ReplaceAPIKeys =>
      <div className="flex flex-col gap-10">
        <div className="text-grey-50">
          {"Call loadBliver() with your Bliver publishable key to configure the SDK library, from your website.This will load and invoke the Bliver Checkout experience instead of the Stripe UI Elements."->React.string}
        </div>
    ...
    | ReconfigureCheckout =>
      <div className="flex flex-col gap-10">
        <div className="text-grey-50">
          {"Reconfigure checkout form to import from Bliver. This will import the Bliver unified checkout dependencies."->React.string}
        </div>
        <div className="flex flex-col gap-2">
          <div className="text-grey-900 font-medium"> {"Publishable Key"->React.string} </div>
          <UserOnboardingUIUtils.PublishableKeyArea />
