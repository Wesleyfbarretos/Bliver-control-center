...
let getStatData = (
  ...
  | ApiCount => {
      title: "API Count",
      tooltipText: "API request count is the tally of requests made to the Bliver APIs, reflecting the volume of interactions and usage during a defined timeframe.",
      deltaTooltipComponent: AnalyticsUtils.singlestatDeltaTooltipFormat(
